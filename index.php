      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Find the right car for you at ABBAS MOTOR.</h1>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Best <span>Cars For Yourself at ABBAS MOTOR. We offer and deliver the best cars worldwide.</span></h2>
      <p>There are many variations of cars in ABBAS MOTOR. Make your choice of cars and get it hired today. your satisfaction is our priority./p>
    </div>
    <div class="row"> 
...
<span class="price">N<?php echo htmlentities($result->PricePerDay);?> /Day</span> 
</div>
