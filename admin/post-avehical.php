...
if(isset($_POST['submit']))
  {
		...
		$sql ="SELECT * FROM tblvehicles WHERE VehiclesTitle=:vehicletitle and VehiclesBrand=:brand";
...
<div class="form-group">
<label class="col-sm-2 control-label">Price Per Day(in NAIRA)<span style="color:red">*</span></label>
<div class="col-sm-4">
